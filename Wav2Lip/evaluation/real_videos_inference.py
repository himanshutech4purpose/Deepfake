...
def main():
	...
	for idx, line in enumerate(tqdm(lines)):
		...
		command = 'ffmpeg -loglevel panic -y -i {} -strict -2 {}'.format(audio_src, os.path.join(base_dir, '../temp/temp.wav'))
		...
		command = 'ffmpeg -loglevel panic -y -i {} -i {} -strict -2 -q:v 1 {}'.format(os.path.join(base_dir, '../temp/temp.wav'), 
								os.path.join(base_dir, '../temp/result.avi'), vid)
		subprocess.call(command, shell=True)
